...
## Rezolvare exercitii recapitulative functii prelucrare siruri
Nota: enuntul il gasesti in fisierul pe care l-ai primit sesiunea trecuta
1. 
    ```c++
        #include <iostream>
        #include <cstring>
    ...
    ```c++
        ...
        int main(){
            ...
            if (rezultatComparare == 0) {
                ...
                cout  << "Al doilea sir este mai mic lexicografic decat al doilea.";
            }  else {
...
7. Rezolvare
    ```c++
        ...
        int main(){
            ...
            cout << "Caracterul " << character << " apare de " << contor << " ori.";
    ...
    ```c++
        ...
        int main(){
            ...
            if (subsir != NULL) {
                ...
                *subsir = '\0'; // asta o explicam in clasa => ce face, termina sirul inainte de subsire deoarece el pointeaza catre primul caracter din subsirul gasit
                strcpy(rezultat, sir1); // copiaza prima parte
                strcat(rezultat, subsir + strlen(sir2)); // adauga partea de dupa subsir
                cout << "Sirul dupa stergerea subsirului: " << rezultat << endl;
            } else {
                cout << "Sirul " << sir2 << " nu apare ca si subsir in sirul dat";
            }
        }
    ```
...
10. Rezolvare
    ```c++
        ...
        int main(){
            ...
            while (*p != '\0') {
                char *aparitieSubsir = strstr(p, subsir); // cauta subșirul in s, incepand de la p
