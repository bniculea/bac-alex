...
## Agenda
- Rezolvare varianta BAC iunie 2024
        ...
        * b
            ```c++
                ...
                int main() {
                    ...
                    //Tratam cazul in care fix la finalul fisierului avem cea mai mare secventa
                    if (lungimeCurenta >= lungimeMax && lungimeCurenta > 1) {
                        lungimeMax = lungimeCurenta;
                        startSecventa = cotaAnterioara - lungimeMax + 1;
                    }
